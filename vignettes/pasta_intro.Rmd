...
In the following a less naive application-examples are shown:

Let us assume that we want to create a fancy animation with some screen-caps of our favorite spaghetti-western. In the following is some `pasta` code that shows how we can download a set of chosen pictures from one of the many nice cites that provide the captures
